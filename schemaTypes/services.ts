...
const services: IServices = {
    ...
    fieldsets: [
        ...
        { name: 'topTextSection', title: 'Top Text Section', options: { collapsible: true, collapsed: true } },
        { name: 'recruitingSection', title: 'Recruiting Section', options: { collapsible: true, collapsed: true } },
        { name: 'hireSection', title: 'Hire Section', options: { collapsible: true, collapsed: true } },
        { name: 'headhuntingSection', title: 'Headhunting Section', options: { collapsible: true, collapsed: true } },
        { name: 'counselingSection', title: 'Counseling Section', options: { collapsible: true, collapsed: true } },
        { name: 'middleTextSection', title: 'Middle Text Section', options: { collapsible: true, collapsed: true } },
        { name: 'adaptedToNeedsSection', title: 'Adapted to Needs Section', options: { collapsible: true, collapsed: true } },
        { name: 'personalityTestAndAbilityTestSection', title: 'Personality Test and Ability Test Section', options: { collapsible: true, collapsed: true } },
    ],
    initialValue: {
        title: 'Services',  
    },
